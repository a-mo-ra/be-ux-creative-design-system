    ...
    <div className="space-y-8 max-w-7xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-neutral-600">Escala tipográfica hierárquica responsiva com especificações para Figma</p>
        </div>
      </div>

      {/* Font Family Info */}
      <div className="bg-gradient-to-br from-emerald-50 to-white rounded-xl p-6 border border-emerald-200/50">
        <h3 className="text-lg font-semibold text-neutral-900 mb-4">Família de Fonte</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-neutral-800 mb-3">Inter - Font Family</h4>
          ...
          <div>
            <h4 className="font-medium text-neutral-800 mb-3">Configuração Importante</h4>
            ...
            <div key={item.class} className="group p-4 border border-neutral-200 rounded-lg hover:shadow-elevation-1 transition-all duration-200">
              <div className="grid lg:grid-cols-3 gap-4 mb-4">
                <div className="lg:col-span-2">
                  ...
                  <div className="grid sm:grid-cols-2 gap-2 text-xs text-neutral-500 mb-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-neutral-600 hover:text-brand-600 hover:bg-brand-50 rounded-lg transition-all duration-200"
                  >
              ...
              <div className={`${item.class} font-display font-semibold text-neutral-900 leading-tight mb-3`}>
                {item.example}
              </div>
              
              <div className="bg-neutral-50 p-3 rounded text-xs font-mono text-neutral-600">
        ...
        <div className="space-y-6">
          {textSizes.map((item) => (
            <div key={item.class} className="group p-4 border border-neutral-200 rounded-lg hover:shadow-elevation-1 transition-all duration-200">
              ...
              <div className={`${item.class} text-neutral-700 leading-relaxed mb-3`}>
                {item.example}
              </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-elevation-2 border border-neutral-200/50">
        <h3 className="text-lg font-semibold text-neutral-900 mb-6">Diretrizes Responsivas</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-4 border border-neutral-200 rounded-lg">
            ...
            <h4 className="font-medium text-neutral-800 mb-3">Mobile (320-768px)</h4>
          ...
          <div className="text-center p-4 border border-neutral-200 rounded-lg">
            ...
            <h4 className="font-medium text-neutral-800 mb-3">Tablet (768-1024px)</h4>
            <div className="text-xs text-neutral-600 space-y-1">
          ...
          <div className="text-center p-4 border border-neutral-200 rounded-lg">
            ...
            <h4 className="font-medium text-neutral-800 mb-3">Desktop (1024px+)</h4>
            <div className="text-xs text-neutral-600 space-y-1">
